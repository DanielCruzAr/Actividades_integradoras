...
void menu(){
	...
	cout << "Opcion 10: juntar los productos para adulto en disjoint sets" << endl;
...
int main(){
	...
	Dj<int, string> set(producto(data, 27), sze);
	...
	while(opcion <11 && opcion >-1){
      ...
      switch(opcion){
		  ...
		  case 10:
			 ...
			 set.Union(1,6);
			 set.Union(1,7);
			 cout << "Total de disjoint sets = " << set.numSets() << endl;
			 cout << set.toString();
		}
	}
